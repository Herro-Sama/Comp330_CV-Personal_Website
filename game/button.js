 ...
 */
class GenericButton extends ButtonBase
{
...
/*
    KeyButton - button for handling musical key
 */
class TextBox extends ButtonBase
{
    constructor(label,rect)
    {
        super(rect);
...
/*
    ModeButton -    button that holds mode object
                    This may be better served by putting all the mode information into the CharGen class (or mode db)
